...
const Error = () => {
    return (
        <div>
            ...
            <div>
                <Link to='/'>
                    <button className="btn bg-cyan-400 text-black rounded-xl m-3">Back To Home</button>
                </Link>
                ...
                <h2 className="bg-black text-cyan-400 p-4">Error Code: E-1301: Your number has been blocked by the recipient.
