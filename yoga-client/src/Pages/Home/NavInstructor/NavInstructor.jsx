...
const NavInstructor = () => {
    ...
    useEffect(()=>{
       fetch("https://yoga-time.vercel.app/instructor")
       .then(res=>res.json())
       .then(data=>{
           console.log(data);
           setItems(data);
    ...
    return (
        <div>
              <h1 className="font-black text-cyan-400 text-4xl border rounded-xl border-cyan-400 mr-2 ml-2 p-3  text-center mt-10 mb-10">Popular Instructor</h1>
