...
const SignUp = () => {
    ...
    return (
        <div className="hero bg-gradient-to-r from-cyan-500 via-black to-cyan-400">
            ...
            <h1 className="text-3xl text-center font-bold text-white">Sign Up</h1>
             ...
             <div className="form-control">
              ...
              <div className="form-control mt-6">
                <input className="btn btn-outline text-cyan-400" type='submit' value="Sign Up" />
                
              </div>
              
             </form>
             <p className='my-4 text-center text-white'>Already Have an Account ? : <Link  className="text-cyan-400 font-bold" to="/login">Login</Link></p>
            </div>
          </div>
        </div>
      </div>
